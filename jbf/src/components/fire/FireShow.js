...
class FireShow extends Component{
    constructor(props){
        super(props)
        this.state={
            makeUpdates: false,
    ...
    cancleChange = () => {
        this.setState({
            ...
            pump_erp: this.state.originalData.pump_erp,
    ...
    changeCompletion = (bol) => {
        ...
        fetch('http://localhost:3000/fire/completed',{
            method:'PUT',
            headers:{
    ...
    deleteJob = () => {
        fetch('http://localhost:3000/fire/'+this.props.id,{
            method:'DELETE',
    ...
    pullFireData = () => {
        fetch('http://localhost:3000/fire/'+this.props.id,{method:'GET', headers:{Authorization : `Token ${Auth.getToken()}`}})
        .then((res) => {
           res.json()
           .then((data) => {
               console.log(data)
                ...
                {this.state.makeUpdates? <> {this.state.id? <div>
                    ...
                    <div className="show-display">
                        <ul>
                            ...
                            <li><strong>Pump ERP:</strong> {this.state.pump_erp} </li>
